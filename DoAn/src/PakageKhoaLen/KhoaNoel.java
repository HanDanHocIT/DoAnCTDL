...
public class KhoaNoel extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Ông Già Noel Len";
    ...
    public KhoaNoel() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoanoel.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa hình đầu ông già Noel được làm thủ công từ len mềm mại, nổi bật với gương mặt vui tươi, chiếc mũ đỏ đặc trưng và bộ râu trắng đáng yêu. Sản phẩm mang đậm không khí Giáng Sinh, là phụ kiện nhỏ xinh để trang trí chìa khóa, túi xách hoặc làm quà tặng ý nghĩa trong mùa lễ hội.\r\n"
                + ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoanoel.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaNoel::new);
    }
}
