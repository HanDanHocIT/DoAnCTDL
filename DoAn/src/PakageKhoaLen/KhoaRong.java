...
public class KhoaRong extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Rồng Len";
    ...
    public KhoaRong() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoarong.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa hình con rồng được làm thủ công từ len mềm mại, tái hiện hình ảnh chú rồng mạnh mẽ nhưng không kém phần dễ thương. Với thiết kế tinh xảo và màu sắc nổi bật, sản phẩm tượng trưng cho sức mạnh, quyền uy và sự may mắn. Đây là phụ kiện độc đáo để trang trí chìa khóa, balo, túi xách hoặc làm quà tặng ý nghĩa cho bạn bè và người thân trong các dịp đặc biệt.\r\n"+ ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoarong.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaRong::new);
    }
}
