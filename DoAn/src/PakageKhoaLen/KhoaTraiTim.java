...
public class KhoaTraiTim extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Trái Tim Len";
    ...
    public KhoaTraiTim() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoatraitim.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 50,000đ  (Giảm 13%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
        		+ "Mã sản phẩm: BHCK07<br>"
                + "Giá niêm yết: 56,000đ<br>"
                + "Kích thước: 12x20cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa hình trái tim được làm thủ công từ len mềm mại, với thiết kế đơn giản nhưng đầy ý nghĩa. Sản phẩm tượng trưng cho tình yêu, sự gắn kết và sự trân trọng. Với màu sắc tươi sáng, đây là phụ kiện xinh xắn để trang trí chìa khóa, túi xách hoặc balo, đồng thời là món quà ý nghĩa để thể hiện tình cảm trong các dịp đặc biệt như ngày Valentine, kỷ niệm hay sinh nhật.\r\n"
                + ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoatraitim.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 50,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 50000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaTraiTim::new);
    }
}
