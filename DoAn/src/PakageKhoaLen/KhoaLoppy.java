...
public class KhoaLoppy extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Loppy Len";
    ...
    public KhoaLoppy() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoaloppy.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa len Loppy màu hồng được làm thủ công từ len cao cấp, tái hiện hình ảnh chú thỏ Loppy đáng yêu với đôi tai dài và biểu cảm dễ thương. Với màu hồng nhẹ nhàng, sản phẩm mang lại cảm giác ấm áp, ngọt ngào và đáng yêu. Đây là phụ kiện hoàn hảo để trang trí chìa khóa, túi xách, balo, đồng thời là món quà nhỏ ý nghĩa dành tặng bạn bè và người thân trong các dịp đặc biệt.\r\n"+ ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoaloppy.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaLoppy::new);
    }
}
