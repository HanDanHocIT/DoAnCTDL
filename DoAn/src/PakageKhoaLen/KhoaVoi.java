...
public class KhoaVoi extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Voi Len";
    ...
    public KhoaVoi() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoavoi.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc Khóa Hình Con Voi được làm thủ công từ len mềm mại, tái hiện hình ảnh chú voi đáng yêu và ngộ nghĩnh. Sản phẩm không chỉ là phụ kiện trang trí tinh tế cho chìa khóa, túi xách mà còn mang ý nghĩa may mắn, thịnh vượng và sự bảo vệ. Đây là món quà nhỏ xinh, ý nghĩa dành tặng cho bạn bè hoặc người thân trong các dịp đặc biệt.\r\n"
                + ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoavoi.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaVoi::new);
    }
}
