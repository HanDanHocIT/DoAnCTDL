...
public class KhoaHoa extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Hoa Len";
    ...
    public KhoaHoa() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoahoa.jpg");
        ...
        JLabel detailsLabel = new JLabel("<html>"
        		+ "Mã sản phẩm: BHCK01<br>"
                + "Giá niêm yết:57,000đ<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa hình hoa được làm thủ công từ len cao cấp, mang vẻ đẹp nhẹ nhàng và tinh tế. Với thiết kế hình bông hoa rực rỡ, sản phẩm tượng trưng cho sự tươi mới, niềm vui và năng lượng tích cực. Đây là phụ kiện xinh xắn để trang trí chìa khóa, túi xách hoặc balo, đồng thời là món quà ý nghĩa dành tặng người thân yêu trong các dịp đặc biệt.\r\n"+ "\r\n"
+ ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoahoa.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaHoa::new);
    }
}
