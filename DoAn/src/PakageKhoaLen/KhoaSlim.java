...
public class KhoaSlim extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Slim(Con thỏ)";
    ...
    public KhoaSlim() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoaslim.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc khóa hình Slim được làm thủ công tỉ mỉ, mô phỏng nhân vật Slim trong Liên Quân với các chi tiết sống động và màu sắc bắt mắt. Sản phẩm là lựa chọn hoàn hảo cho các fan hâm mộ tựa game này, vừa thể hiện cá tính, vừa là món phụ kiện độc đáo để trang trí chìa khóa, balo hay túi xách. Đây cũng là món quà thú vị cho các dịp đặc biệt.\r\n"+ ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoaslim.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaSlim::new);
    }
}
