...
public class KhoaMeo extends JFrame {

    private static final String PRODUCT_NAME = "Khóa Mèo Len";
    ...
    public KhoaMeo() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("MocKhoaLen\\khoameo.jpg");
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Móc Khóa Hình Con Mèo được làm thủ công tỉ mỉ từ len cao cấp, tái hiện hình ảnh chú mèo dễ thương và sống động. Sản phẩm mang ý nghĩa may mắn, bình an và sự gần gũi. Đây là món phụ kiện xinh xắn để trang trí chìa khóa, balo hoặc túi xách, đồng thời là món quà ý nghĩa dành tặng cho những người yêu thích mèo trong các dịp đặc biệt.\r\n"+ ""                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("MocKhoaLen\\khoameo.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(KhoaMeo::new);
    }
}
