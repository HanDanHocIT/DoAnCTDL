...
public class HoaHongDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Hồng Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaHongDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_hong.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 200,000đ  (Giảm 20%)");
        ...
        JLabel detailsLabel = new JLabel("<html>"
                ...
                + "Giá niêm yết: 240,000đ<br>"
                + "Kích thước: 15x35cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Hồng Len được làm thủ công từ sợi len mềm mại, tượng trưng cho tình yêu và sự lãng mạn. Với vẻ đẹp tinh tế và bền bỉ, hoa hồng len là món quà ý nghĩa để bày tỏ tình cảm trong các dịp đặc biệt hoặc để trang trí không gian sống thêm phần ấm áp và sang trọng.\r\n"
                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_hong.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaHongDetails::new);
    }
}
