...
public class HoaMauDonDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Mẫu Đơn Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaMauDonDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\chau_hoa_mau_don.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 500,000đ  (Giảm 15%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL10<br>"
                + "Giá niêm yết: 575,000đ<br>"
                + "Kích thước: 25x50cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Mẫu Đơn Len được làm thủ công từ len mềm mại, mang vẻ đẹp sang trọng và tinh tế. Là biểu tượng của sự phú quý, thịnh vượng và hạnh phúc, hoa mẫu đơn len thích hợp để trang trí không gian sống hoặc làm quà tặng ý nghĩa trong các dịp quan trọng, thể hiện tình cảm chân thành và sự trân quý.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\chau_hoa_mau_don.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 500,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 500000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaMauDonDetails::new);
    }
}
