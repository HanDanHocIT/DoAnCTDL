...
public class HoaLavenderDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Lavender Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaLavenderDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_lavender.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 350,000đ  (Giảm 10%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL08<br>"
                + "Giá niêm yết: 385,000đ<br>"
                + "Kích thước: 20x45cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Lavender Len được làm thủ công từ len cao cấp, mang vẻ đẹp dịu dàng và lãng mạn. Với sắc tím đặc trưng, hoa lavender len tượng trưng cho sự bình yên và tình yêu chân thành. Sản phẩm phù hợp để trang trí không gian sống hoặc làm quà tặng ý nghĩa, thể hiện sự trân trọng và gắn kết.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_lavender.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 350,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 350000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaLavenderDetails::new);
    }
}
