...
public class HoaCamChuongDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Cẩm Chướng Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaCamChuongDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_cam_chuong.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 50,000đ  (Giảm 33%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL04<br>"
                + "Giá niêm yết: 67,000đ<br>"
                + "Kích thước: 12x15cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                + "Hoa cẩm chướng len được làm thủ công, mang vẻ đẹp thanh lịch và ý nghĩa sâu sắc. "
                + "Sản phẩm thích hợp để làm quà tặng hoặc trang trí phòng khách, bàn làm việc. "
                + "Mỗi bông hoa là tâm huyết của người thợ thủ công, tượng trưng cho sự tinh tế và sự trân trọng."
                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_cam_chuong.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaCamChuongDetails::new);
    }
}
