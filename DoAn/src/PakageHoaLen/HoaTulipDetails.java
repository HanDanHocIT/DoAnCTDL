...
public class HoaTulipDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Tulip Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaTulipDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_tulip_len.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 400,000đ  (Giảm 8%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL12<br>"
                + "Giá niêm yết: 432,000đ<br>"
                + "Kích thước: 23x40cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Tulip Len được thiết kế tỉ mỉ từ chất liệu len mềm mại, mang vẻ đẹp thanh lịch và duyên dáng. Với màu sắc rực rỡ và ý nghĩa tượng trưng cho sự tươi mới, hy vọng, hoa tulip len thích hợp để trang trí không gian sống hoặc làm quà tặng ý nghĩa trong các dịp đặc biệt.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_tulip_len.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaTulipDetails::new);
    }
}
