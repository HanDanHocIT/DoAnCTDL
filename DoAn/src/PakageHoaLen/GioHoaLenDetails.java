...
public class GioHoaLenDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Len 5 Cánh";
    private static final String ORDERS_FILE = "orders.csv";

    public GioHoaLenDetails() {
        // Thiết lập cửa sổ
        ...
        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL02<br>"
                + "Giá niêm yết: 378,000đ<br>"
                + "Kích thước: 20x30cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Giỏ Hoa Len Handmade kết hợp tinh tế các bông hoa len rực rỡ trong chiếc giỏ nhỏ xinh, mang vẻ đẹp nhẹ nhàng và ý nghĩa. Phù hợp trang trí phòng khách, bàn làm việc hoặc làm quà tặng trong các dịp đặc biệt"   + "</html>");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(GioHoaLenDetails::new);
    }
}
