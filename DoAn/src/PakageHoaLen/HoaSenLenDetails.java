...
public class HoaSenLenDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Sen Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaSenLenDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_sen_len.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 300,000đ  (Giảm 12%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL11<br>"
                + "Giá niêm yết: 336,000đ<br>"
                + "Kích thước: 19x34cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                + "Hoa Sen Len được làm thủ công tỉ mỉ, thể hiện sự tinh khiết và thanh cao. Đây là sản phẩm mang ý nghĩa sâu sắc, tượng trưng cho sự bình yên và vẻ đẹp tâm hồn. Hoa Sen Len thích hợp để trang trí không gian sống hoặc làm quà tặng ý nghĩa trong các dịp quan trọng."                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_sen_len.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 300,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 300000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaSenLenDetails::new);
    }
}
