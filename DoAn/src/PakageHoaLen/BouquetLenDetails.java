...
public class BouquetLenDetails extends JFrame {

    private static final String PRODUCT_NAME = "Bouquet Len";
    private static final String ORDERS_FILE = "orders.csv";

    public BouquetLenDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\bouquet.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 400,000đ  (Giảm 20%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL01<br>"
                + "Giá niêm yết: 480,000đ<br>"
                + "Kích thước: 20x40cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Bouquet Len là bó hoa được tạo nên từ nhiều bông hoa len thủ công, kết hợp hài hòa màu sắc và kiểu dáng, mang lại vẻ đẹp tinh tế và nổi bật. Sản phẩm tượng trưng cho sự gắn kết, yêu thương và lời chúc tốt đẹp, phù hợp để làm quà tặng trong các dịp đặc biệt hoặc trang trí không gian sống thêm phần ấm áp và ý nghĩa.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\bouquet.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 400,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 400000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(BouquetLenDetails::new);
    }
}
