...
public class HoaLinhLanDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Linh Lan Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaLinhLanDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_linh_lan.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 180,000đ  (Giảm 18%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL09<br>"
                + "Giá niêm yết: 213,000đ<br>"
                + "Kích thước: 17x32cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Linh Lan Len được làm thủ công tinh xảo từ len mềm mại, tái hiện vẻ đẹp nhỏ nhắn và thanh thoát của loài hoa linh lan. Tượng trưng cho sự thuần khiết, may mắn và niềm hạnh phúc trọn vẹn, hoa linh lan len là lựa chọn lý tưởng để trang trí không gian sống hoặc làm quà tặng ý nghĩa cho những người thân yêu.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_linh_lan.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 180,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 180000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaLinhLanDetails::new);
    }
}
