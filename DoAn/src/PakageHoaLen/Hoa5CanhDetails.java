...
public class Hoa5CanhDetails extends JFrame {

    public Hoa5CanhDetails() {
        // Thiết lập cửa sổ
        setTitle("Chi tiết sản phẩm - Hoa Len 5 Cánh");
        setSize(800, 600);
        ...
        // Tiêu đề
        JLabel titleLabel = new JLabel("Hoa Len 5 Cánh", JLabel.CENTER);
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\len5canh.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 450,000đ  (Giảm 18%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCL03<br>"
                + "Giá niêm yết: 531,000đ<br>"
                + "Kích thước: 10x10cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Hoa Len 5 Cánh được làm từ len cao cấp, mang vẻ đẹp đơn giản, tinh tế. Sản phẩm thích hợp trang trí hoặc làm quà tặng ý nghĩa, thể hiện sự khéo léo và tâm huyết của người thợ."
                + "</html>");
    ...
    private void openOrderForm() {
        ...
        JFrame orderFrame = new JFrame("Đặt mua Hoa Len 5 Cánh");
        ...
        orderPanel.setBackground(new Color(0xffe3e3)); // Màu 
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\len5canh.jpg");
        Image scaledImage = imageIcon.getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        imageLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel productNameLabel = new JLabel("Hoa Len 5 Cánh");
        ...
        JLabel totalLabel = new JLabel("Tổng: 450,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            totalLabel.setText("Tổng: " + (quantity * 450000) + "đ");
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Hoa5CanhDetails::new);
    }
}
