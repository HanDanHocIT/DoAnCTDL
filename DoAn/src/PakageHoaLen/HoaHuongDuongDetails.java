...
public class HoaHuongDuongDetails extends JFrame {

    private static final String PRODUCT_NAME = "Hoa Hướng Dương Len";
    private static final String ORDERS_FILE = "orders.csv";

    public HoaHuongDuongDetails() {
        // Thiết lập cửa sổ
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AnhHoaLen\\hoa_huong_duong.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 425,000đ  (Giảm 19%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
        		+ "Mã sản phẩm: BHCL07<br>"
                + "Giá niêm yết: 506,000đ<br>"
                + "Kích thước: 12x30cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "<br><b>Miêu tả:</b><br>"
                + "Hoa Hướng Dương Len được làm từ len cao cấp, mang vẻ đẹp tươi sáng và đầy sức sống. Đây là món quà lý tưởng để truyền tải thông điệp về niềm tin, hy vọng và sự mạnh mẽ trong cuộc sống. Sản phẩm phù hợp để trang trí nhà cửa hoặc làm quà tặng cho những dịp đặc biệt.\r\n"
                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AnhHoaLen\\hoa_huong_duong.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 425,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 425000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HoaHuongDuongDetails::new);
    }
}
