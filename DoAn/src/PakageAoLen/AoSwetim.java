...
public class AoSwetim extends JFrame {

    private static final String PRODUCT_NAME = "Áo Sweater Tím";
    ...
    public AoSwetim() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\lentim.jpeg");
        ...
        JLabel priceLabel = new JLabel("Giá: 250,000đ  (Giảm 12%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCH04<br>"
                + "Giá niêm yết:280,000đ<br>"
                + "Kích thước: 50x30cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Áo sweater len màu tím là một món đồ thời trang độc đáo và thanh lịch, mang đến sự phá cách và cá tính cho người mặc. Với chất liệu len mềm mại cùng tông màu tím mộng mơ, đây là lựa chọn lý tưởng cho những ai muốn thể hiện phong cách cá nhân nổi bật nhưng vẫn giữ được sự ấm áp và thoải mái trong mùa thu đông."                                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AoLen\\lentim.jpeg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 250,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 250000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AoSwetim::new);
    }
}
