...
public class AoSwevang extends JFrame {

    private static final String PRODUCT_NAME = "Áo Sweater Vàng";
    ...
    public AoSwevang() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\aovang.jpg");
        ...
        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCH05<br>"
                + "Giá niêm yết: 293,000đ<br>"
                + "Kích thước: 60x30cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Áo sweater len màu vàng là sự kết hợp hoàn hảo giữa sự rực rỡ và ấm áp, mang lại năng lượng tích cực và phong cách nổi bật cho người mặc. Với chất liệu len mềm mại và thiết kế tinh tế, chiếc áo này không chỉ giữ ấm mà còn tạo nên vẻ ngoài trẻ trung, tươi tắn, phù hợp với mọi dịp trong mùa thu đông.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AoLen\\aovang.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AoSwevang::new);
    }
}
