...
public class Cadigantrang extends JFrame {

    private static final String PRODUCT_NAME = "Áo Cadigan Trắng";
    ...
    public Cadigantrang() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\caditrang.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 200,000đ  (Giảm 33%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
        		+ "Mã sản phẩm: BHCL06<br>"
                + "Giá niêm yết: 266,000đ<br>"
                + "Kích thước: 60x40cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Áo cardigan len màu trắng là biểu tượng của sự thanh lịch và nhẹ nhàng, mang đến vẻ đẹp tinh tế và sang trọng cho người mặc. Với chất liệu len mềm mại và thiết kế mở tiện dụng, chiếc áo này không chỉ giữ ấm mà còn là điểm nhấn hoàn hảo cho mọi phong cách thời trang, đặc biệt phù hợp với tiết trời se lạnh của mùa thu đông.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AoLen\\hoodiexanh.jpg");
        ...
        JLabel totalLabel = new JLabel("Tổng: 200,000đ");
        quantitySpinner.addChangeListener(e -> {
            int quantity = (Integer) quantitySpinner.getValue();
            long total = quantity * 200000; // Giá giả định 200,000đ mỗi đơn vị
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Cadigantrang::new);
    }
}
