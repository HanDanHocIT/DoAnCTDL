...
public class AoSwedo extends JFrame {

    private static final String PRODUCT_NAME = "Áo Sweater Đỏ";
    ...
    public AoSwedo() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\lendo.jpeg");
        ...
        JLabel priceLabel = new JLabel("Giá: 225,000đ  (Giảm 19%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCH03<br>"
                + "Giá niêm yết: 268,000đ<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Áo sweater len màu đỏ là sự kết hợp hoàn hảo giữa thời trang và sự ấm áp, mang đến vẻ ngoài nổi bật và phong cách. Với chất liệu len mềm mại cùng tông màu đỏ ấm áp, đây là món đồ không thể thiếu trong tủ quần áo của bạn cho mùa thu đông."                                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AoLen\\lendo.jpeg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AoSwedo::new);
    }
}
