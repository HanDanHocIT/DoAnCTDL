...
public class Aohoodiexanh extends JFrame {

    private static final String PRODUCT_NAME = "Áo Hoodie Xanh";
    ...
    public Aohoodiexanh() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\hoodiexanh.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 300,000đ  (Giảm 18%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
                + "Mã sản phẩm: BHCH01<br>"
                + "Giá niêm yết: 354,000đ<br>"
                + "Kích thước: 50x40cm<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                + "Áo hoodie len màu xanh là một sản phẩm thời trang tiện lợi, mang lại vẻ ngoài vừa hiện đại vừa ấm áp. Với chất liệu len mềm mại và thiết kế tinh tế, sản phẩm này phù hợp với cả nam và nữ trong các dịp thường ngày hoặc dạo phố."
                + "</html>");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Aohoodiexanh::new);
    }
}
