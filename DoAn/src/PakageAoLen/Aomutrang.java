...
public class Aomutrang extends JFrame {

    private static final String PRODUCT_NAME = "Áo Mũ Trắng";
    ...
    public Aomutrang() {
        ...
        // Ảnh sản phẩm
        ImageIcon originalIcon = new ImageIcon("AoLen\\aotrang.jpg");
        ...
        JLabel priceLabel = new JLabel("Giá: 350,000đ  (Giảm 8%)");
        priceLabel.setFont(new Font("Arial", Font.BOLD, 18));
        priceLabel.setForeground(new Color(34, 139, 34));
        infoPanel.add(priceLabel);

        JLabel detailsLabel = new JLabel("<html>"
        		+ "Mã sản phẩm: BHCH02<br>"
                + "Giá niêm yết: 378,000đ<br>"
        ...
        JLabel descriptionLabel = new JLabel("<html>"
                + "<br><b>Miêu tả:</b><br>"
                +"Áo mũ trắng len là một item thời trang mang tính biểu tượng cho sự tinh tế và đơn giản, nhưng vẫn không kém phần hiện đại. Với màu trắng tinh khôi và chất liệu len cao cấp, sản phẩm này không chỉ mang đến sự thoải mái mà còn giúp bạn nổi bật với phong cách nhẹ nhàng, thanh lịch.\r\n"                + "</html>");
    ...
    private void openOrderForm() {
        ...
        ImageIcon imageIcon = new ImageIcon("AoLen\\aotrang.jpg");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Aomutrang::new);
    }
}
